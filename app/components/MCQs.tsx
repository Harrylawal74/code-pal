...
/** A question object is passed to this function */
export default function MCQs({question}: {question: Question}) {
    return(
        <form className="mx-5 my-5 bg-blue-900 px-5 py-7 rounded-4xl space-y-10 max-w-150 w-full flex flex-col items-center " >
            ...
            <button type="submit" className="bg-[var(--color-button-purple)] px-5 py-2 rounded-3xl flex justify-center items-center">Hello</button>
        </form>
    )
}