      ...
      <div className="mx-5 text-2xl bg-gradient-to-b from-[#121723] to-[#131623] px-10 py-15 rounded-4xl gap-3 max-w-350 w-full max-h-[1000px] flex flex-col items-center border-2 border-[#2d2c47]">
        ...
        {question.options.map((option, index) => (
          <label
            key={index}
            className={
              "cursor-pointer bg-gradient-to-r from-[#1b202d] to-[#171c29] hover:from-[#212632] hover:to-[#1d222e] rounded-2xl px-10 h-30 flex items-center gap-6 w-full mb-5 shadow-sm shadow-black hover:bg-gray-400 border-1 border-[#1a202b] hover:border-[#3b395a] hover:translate-x-[5px]  transition-all duration-300 "
            }
          >
